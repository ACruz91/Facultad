    ...
    <div class="container">
      ...
      <div class="main-content">
          ...
          <div class="content">
			...
			$sql = "DELETE FROM evaluacion WHERE id_asignatura = '$id_asignatura'"; 
			$result = mysql_query($sql);
				if($result === false) {
					echo "<h1>No se pudo borrar la Asignatura.  . mysql_error() . .  . mysql_errno()</h1>";
          echo "<center><a class=pure-button pure-button-primary href=/Facultad/Evaluacion/PHP/consulta.php>Volver</a></center>";
				}
				else {
					echo "<h1>La Asignatura se ha borrado correctamente</h1>";
          echo "<center><a class=pure-button pure-button-primary href=/Facultad/Evaluacion/PHP/consulta.php>Volver</a></center>";
				} 
