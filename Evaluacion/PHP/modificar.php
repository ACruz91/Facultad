  ...
  <body>
    <div class="container">
      ...
      <div class="main-content">
          ...
          <div class="content">         
              <h1>Modificar</h1>
              <form class="pure-form pure-form-stacked" method = "POST" action="/Facultad/Evaluacion/PHP/modificar_final.php">                
                <fieldset>
                  <?php
                    ...
                    echo "<input type=text name=comentario_alumno value=$comentario_alumno placeholder =Comentario...>";
                    echo "<input type=text name=id_asignatura value=$id_asignatura placeholder =ID Asignatura...>";
                    echo "<input type=text name=matricula value=$matricula placeholder =Matricula...>";
                    echo "<input type=number name=nota_final value =$nota_final placeholder =Nota Final...>";                                                                                                     
