...
<html>
  ...
  <body>
    <div class="container">
      <div id="sidebar">
          <ul>
              <li><a href="/Facultad/Evaluacion/insertar.html"><i class="fa fa-files-o"></i> Insertar</a></li>
              <li><a href="/Facultad/Evaluacion/consulta.html"><i class="fa fa-list-alt"></i> Consulta</a></li>
      ...
      <div class="main-content">
          ...
          <div class="content">
            ...
            //Busqueda
            $sql= mysql_query("SELECT * FROM evaluacion ORDER BY id_asignatura", $link);
            ...
            do { 
                        echo "<tr> \n";
                        echo "<td>".$row["comentario_alumno"]."</td> \n";
                        ...
                        echo "<form action=/Facultad/Evaluacion/PHP/borrar.php method = post>";
                        ...
                        echo "<form action=/Facultad/Evaluacion/PHP/modificar.php method = post>";
                        echo "<input type=hidden name=comentario_alumno value = $row[comentario_alumno]>";
                        echo "<input type=hidden name=matricula value = $row[matricula]>";                      
                        echo "<input type=hidden name=id_asignatura value = $row[id_asignatura]>";
                        echo "<input type=hidden name=matricula_antiguo value = $row[matricula]>";                      
                        echo "<input type=hidden name=id_asignatura_antiguo value = $row[id_asignatura]>";                        
                        echo "<input type=hidden name=nota_final value = $row[nota_final]>";                        
            ...
            echo "<center><a class=pure-button href = /Facultad/Evaluacion/insertar.html>";
