    ...
    <div class="container">
      ...
      <div class="main-content">
          ...
          <div class="content">
			...
			$sql = "INSERT INTO evaluacion (comentario_alumno, matricula, id_asignatura, nota_final) VALUES ('$comentario_alumno', '$matricula', '$id_asignatura', '$nota_final')";
  
			$result = mysql_query($sql);
			if($result === false) {
			    echo "No se pudieron insertar los datos de la evaluacion. " . mysql_error() . ". " . mysql_errno();
          echo "<center><a class=pure-button pure-button-primary href=/Facultad/Evaluacion/PHP/consulta.php>Volver</a></center>";          
			}
        else {
              echo "<center><h1>La Evaluacion se ha creado correctamente</h1></center>";
              echo "<center><a class=pure-button pure-button-primary href=/Facultad/Evaluacion/PHP/consulta.php>Volver</a></center>"; 
        }        
			?>
      </div>
