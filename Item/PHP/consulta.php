...
<html>
  ...
  <body>
    <div class="container">
      <div id="sidebar">
          <ul>
              <li><a href="/Facultad/Item/insertar.html"><i class="fa fa-files-o"></i> Insertar</a></li>
              <li><a href="/Facultad/Item/"><i class="fa fa-list-alt"></i> Consulta</a></li>
      ...
      <div class="main-content">
          ...
          <div class="content">
            ...
            //Busqueda
            $sql= mysql_query("SELECT * FROM item ORDER BY id_item", $link); 
            ...
            do { 
                        ...
                        echo "<form action=/Facultad/Item/PHP/borrar.php method = post>";
                        ...
                        echo "<form action=/Facultad/Item/PHP/modificar.php method = post>";
