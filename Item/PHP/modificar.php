  ...
  <body>
    <div class="container">
      ...
      <div class="main-content">
          ...
          <div class="content">         
              <h1>Modificar</h1>
              <form class="pure-form pure-form-stacked" method = "POST" action="/Facultad/Item/PHP/modificar_final.php">                
                <fieldset>
                  <?php
                    ...
                    echo "<input type=text name=categoria value=$categoria placeholder = Categoria>";
