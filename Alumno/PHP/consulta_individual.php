...
<html>
  ...
  <body>
    <div class="container">
      <div id="sidebar">
          <ul>
              <li><a href="/Facultad/Persona/consulta.html"><i class="fa fa-list-alt"></i> Consulta</a></li>
      ...
      <div class="main-content">
          ...
          <div class="content">
            ...
            echo "<center><a class=pure-button pure-button-primary href=/Facultad/Alumno/PHP/consulta.php>Volver</a></center>";  
            } 
            ?>
                <style scoped>
