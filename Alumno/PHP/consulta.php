...
<html>
  ...
  <body>
    <div class="container">
      <div id="sidebar">
          <ul>
              <li><a href="/Facultad/Persona/PHP/consulta.html"><i class="fa fa-list-alt"></i> Consulta</a></li>
      ...
      <div class="main-content">
          ...
          <div class="content">
            ...
            //Busqueda
            $sql= mysql_query("SELECT distinct persona.dni, persona.nombre, persona.apellidos, persona.fotografia, persona.email, persona.tipo_persona, alumno.matricula FROM persona, alumno WHERE persona.dni=alumno.dni AND tipo_persona= 'alumno' ORDER BY persona.apellidos", $link); 
