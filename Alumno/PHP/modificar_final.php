          ...
          <div class="content">         
                <?php 
                  ...
                  $result = mysql_query($sql); 
                    if($result === false) {
                      echo "No se pudo modificar la Persona. " . mysql_error() . ". " . mysql_errno();
                      echo "<a class=pure-button pure-button-primary href=/BDA/Alumno/PHP/consulta.php>Volver</a>"; 
                    }
                    else {
                      echo "<center><h1>Los datos se han guardado</h1></center>";
                      echo "<center><a class=pure-button pure-button-primary href=/BDA/Alumno/PHP/consulta.php>Volver</a></center>"; 
                    } 
                ?> 
          </div>
      </div>
