  ...
  <body>
    <div class="container">
      ...
      <div class="main-content">
          ...
          <div class="content">         
              <h1>Modificar</h1>
              <form class="pure-form pure-form-stacked" method = "POST" action="/Facultad/Alumno/PHP/modificar_final.php">                
                <fieldset>
                  <?php
                    ...
                    echo "<input type=email name=email value=$email placeholder = Correo...>";                                                                              
