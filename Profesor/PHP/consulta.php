    ...
    <div class="container">
      ...
      <div class="main-content">
          ...
          <div class="content">
            ...
            //Busqueda
            $sql= mysql_query("SELECT persona.dni, persona.nombre, persona.apellidos, persona.fotografia, persona.email, persona.tipo_persona, profesor.departamento, profesor.id_profesor FROM persona, profesor WHERE persona.dni=profesor.dni AND tipo_persona= 'profesor' order by persona.apellidos", $link); 
            ...
            do { 
                        ...
                        echo "<form action=/Facultad/Profesor/PHP/borrar.php method = post>";
                        ...
                        echo "<form action=/Facultad/Profesor/PHP/modificar.php method = post>";
                        echo "<input type=hidden name=nombre value = $row[nombre]>";
                        echo "<input type=hidden name=apellidos value = $row[apellidos]>";
                        echo "<input type=hidden name=email value = $row[email]>";                        
                        echo "<input type=hidden name=dni value = $row[dni]>";
                        echo "<input type=hidden name=id_profesor value = $row[id_profesor]>";
