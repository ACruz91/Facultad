    ...
    <div class="container">
      <div id="sidebar">
          <ul>
              ...
              <li><a href="/Facultad/Profesor/"><i class="fa fa-group"></i> Grupo</a></li>
              <li><a href="/Facultad/Profesor/"><i class="fa fa-university"></i> Profesor</a></li>
              <li><a href="/Facultad/Asignatura/"><i class="fa fa-pencil-square-o"></i> Asignatura</a></li>
              <li><a href="/Facultad/Evaluacion/"><i class="fa fa-bar-chart"></i> Evaluacion</a></li> 
              <li><a href="/Facultad/Item/"><i class="fa fa-paperclip "></i> Item</a></li>   
              <li><a href="/Facultad/Item/"><i class="fa fa-table"></i> Evaluacion - Item</a></li>                                    
      ...
      <div class="main-content">
          ...
          <div class="content">
            ...
            $sql= mysql_query("SELECT * FROM persona WHERE (tipo_persona = 'Alumno' AND nombre = '$nombre')", $link);
            ...
            do { 
                        ...
                        echo "<form action=/BDA/Alumno/PHP/borrar.php method = post>";
                        ...
                        echo "<form action=/BDA/Alumno/PHP/modificar.php method = post>";
