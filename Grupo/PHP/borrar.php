...
;
			...
			$sql = "DELETE FROM grupo WHERE curso_grupo = '$curso_grupo' AND numero_grupo = '$numero_grupo'"; 
			$result = mysql_query($sql);
				if($result === false) {
					echo "<h1>No se pudo borrar el grupo.  . mysql_error() . .  . mysql_errno()</h1>";
          echo "<center><a class=pure-button pure-button-primary href=/Facultad/Grupo/PHP/consulta.php>Volver</a></center>";
				}
				else {
            echo "<center><h1>El Grupo se ha borado correctamente</h1></center>";
            echo "<center><a class=pure-button pure-button-primary href=/Facultad/Grupo/PHP/consulta.php>Volver</a></center>"; 
				} 
