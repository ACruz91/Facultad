    ...
    <div class="container">
      <div id="sidebar">
          <ul>
              ...
              <li><a href="/Facultad/Grupo/PHP/consulta.php"><i class="fa fa-list-alt"></i> Consulta</a></li>
      ...
      <div class="main-content">
          ...
          <div class="content">
            ...
            //Busqueda
            $sql= mysql_query("SELECT * FROM grupo ORDER BY numero_grupo", $link); 
            ...
            do { 
                        echo "<tr> \n"; 
                        echo "<td>".$row["curso_grupo"]."</td> \n";
                        echo "<td>".$row["numero_grupo"]."</td> \n";                        
                        echo "<td>".$row["titulacion"]."</td> \n"; 
                        echo "<td>".$row["max_capacidad"]."</td> \n";

                        //Formulario Oculto para poder pasarle DNI a la funcion para poder borrar
                        echo "<form action=/Facultad/Grupo/PHP/borrar.php method = post>";
                        echo "<input type=hidden name=numero_grupo value = $row[numero_grupo]>";
                        echo "<input type=hidden name=curso_grupo value = $row[curso_grupo]>";                                                   
                        ...
                        echo "<form action=/Facultad/Grupo/PHP/modificar.php method = post>";
                        echo "<input type=hidden name=numero_grupo value = $row[numero_grupo]>";
                        echo "<input type=hidden name=curso_grupo value = $row[curso_grupo]>";
                        echo "<input type=hidden name=titulacion value = $row[titulacion]>";                        
                        echo "<input type=hidden name=max_capacidad value = $row[max_capacidad]>";
