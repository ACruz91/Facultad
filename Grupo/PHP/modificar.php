  ...
  <body>
    <div class="container">
      ...
      <div class="main-content">
          ...
          <div class="content">         
              <h1>Modificar</h1>
              <form class="pure-form pure-form-stacked" method = "POST" action="/Facultad/Grupo/PHP/modificar_final.php">                
                <fieldset>
                  <?php
                    ...
                    echo "<select name=curso_grupo>";
                    echo        "<option>Primero</option>";
                    echo        "<option>Segundo</option>";
                    echo        "<option>Tercero</option>";
                    echo        "<option>Cuarto</option>";                          
                    echo "</select>";
                    echo "<input type=number name=numero_grupo value=$numero_grupo placeholder = Grupo...>";                 
                    echo "<input type=text name=titulacion value=$titulacion placeholder = Titulación...>";                                                                              
                    echo "<input type=number name=max_capacidad value =$max_capacidad placeholder = Capacidad...>";
                    echo "<input type=hidden name=numero_grupo_antiguo value=$numero_grupo>";
                    echo "<input type=hidden name=titulacion_antiguo value=$numero_grupo>";
                    echo "<input type=hidden name=curso_grupo_antiguo value=$curso_grupo>";                    
                  ?>
