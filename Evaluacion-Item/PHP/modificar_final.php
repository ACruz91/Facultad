          ...
          <div class="content">         
                <?php 
                  ...
                  //Recogida de datos por el metodo post
                    ...
                    echo "Antiguo";
                    echo $id_item_antiguo;
                    echo $matricula_antiguo;
                    echo $id_asignatura_antiguo;
                    ...
                    echo $id_asignatura; 
                  //Consulta               
                  $sql = "UPDATE evaluacion_item SET nota_item='$nota_item', comentario_item='$comentario_item', matricula='$matricula', id_item='$id_item', id_asignatura = $id_asignatura WHERE matricula = '$matricula_antiguo' AND id_asignatura = '$id_asignatura_antiguo' AND id_item = '$id_item_antiguo'";
                  $result = mysql_query($sql); 
                    if($result === false) {
                      echo "No se pudo modificar el Evaluacion-Item. " . mysql_error() . ". " . mysql_errno();
                      echo "<a class=pure-button pure-button-primary href=/Facultad/Evaluacion-Item/PHP/consulta.php>Volver</a>"; 
                    }
                    else {
