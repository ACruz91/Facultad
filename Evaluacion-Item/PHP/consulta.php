  ...
  <body>
    <div class="container">
      ...
      <div class="main-content">
          ...
          <div class="content">
              <h1>Listado de Evaluacion-Items</h1>
            <?php
            //Conexion
            ...
            //Busqueda
            $sql= mysql_query("SELECT * FROM evaluacion_item", $link); 
            ...
            do { 
                        echo "<tr> \n"; 
                        echo "<td>".$row["nota_item"]."</td> \n";
                        echo "<td>".$row["comentario_item"]."</td> \n"; 
                        echo "<td>".$row["id_asignatura"]."</td> \n";
                        echo "<td>".$row["matricula"]."</td> \n";
                        echo "<td>".$row["id_item"]."</td> \n";


                        echo "<form action=/Facultad/Evaluacion-Item/PHP/borrar.php method = post>";
                        ...
                        echo "<form action=/Facultad/Evaluacion-Item/PHP/modificar.php method = post>";
                        echo "<input type=hidden name=nota_item value =$row[nota_item]>";
                        echo "<input type=hidden name=comentario_item value =$row[comentario_item]>";
                        echo "<input type=hidden name=id_item value=$row[id_item]>";
                        ...
                        echo "<input type=hidden name=id_item_antiguo value =$row[id_item]>";
                        echo "<input type=hidden name=id_asignatura value =$row[id_asignatura]>";;                        
                        echo "<input type=hidden name=matricula value =$row[matricula]>";                        
            ...
            echo " <center><h1>No se ha encontrado ningun registro</h1></center>"; 
            } 
            ?>
                <style scoped>
