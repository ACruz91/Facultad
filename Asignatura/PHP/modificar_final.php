      ...
      <div class="main-content">
          ...
          <div class="content">         
                <?php 
                  ...
                  //Consulta               
                  $sql = "UPDATE asignatura SET nombre_asignatura='$nombre_asignatura', curso_asignatura='$curso_asignatura', titulacion='$titulacion', numero_creditos = $numero_creditos WHERE id_asignatura = '$id_asignatura'";
                  $result = mysql_query($sql); 
                    if($result === false) {
                      echo "No se pudo modificar la Asignatura. " . mysql_error() . ". " . mysql_errno();
                      echo "<a class=pure-button pure-button-primary href=/Facultad/Asignatura/PHP/consulta.php>Volver</a>"; 
                    }
                    else {
                      echo "<center><h1>La Asignatura se han guardado</h1></center>";
