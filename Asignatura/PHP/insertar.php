    ...
    <div class="container">
      ...
      <div class="main-content">
          ...
          <div class="content">
			...
			$sql = "INSERT INTO asignatura (nombre_asignatura, curso_asignatura, titulacion, numero_creditos) VALUES ('$nombre_asignatura', '$curso_asignatura', '$titulacion', '$numero_creditos')";
  
			$result = mysql_query($sql);
			if($result === false) {
			    echo "No se pudieron insertar los datos de la asignatura. " . mysql_error() . ". " . mysql_errno();
          echo "<center><a class=pure-button pure-button-primary href=/Facultad/Asignatura/PHP/consulta.php>Volver</a></center>";          
			}
        else {
              echo "<center><h1>La Asignatura se ha creado correctamente</h1></center>";
              echo "<center><a class=pure-button pure-button-primary href=/Facultad/Asignatura/PHP/consulta.php>Volver</a></center>"; 
        }        
			?>
      </div>
